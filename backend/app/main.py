...
from app.api import auth, clientes, setup, proyectos, presupuesto as presupuestos, recibo as recibos, orden_pago as ordenes_pago, dashboard, obra as obras, tarea as tareas, informe, portal
from app.models import user, cliente, proyecto, presupuesto, recibo, orden_pago, obra, tarea, informe as informe_models  # noqa: F401
